  ...
  return (
    ...
    <div className="container flex flex-wrap items-center pt-4 pb-12 mx-auto">
        ...
        <div className="flex flex-col w-full p-6 md:w-1/3 xl:w-1/4">
                <a href="#">
                    <img className="hover:grow hover:shadow-lg" src="https://images.unsplash.com/photo-1555982105-d25af4182e4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=htmlFormat&fit=crop&w=400&h=400&q=80" />
                    <div className="flex items-center justify-between pt-3">
                        <p className="">Product Name</p>
                        <svg className="w-6 h-6 text-gray-500 fill-current hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
