 ...
 */
export const SHELF_CONFIG: ModelConfig = {
  id: 'shelf-v1',
  name: 'Bedroom Shelf',
  ...
  scale: 0.012,
  // Position the shelf so its back edge sits near the room wall (same strategy
  // used by the cabinet config). This prevents the shelf from appearing dead
  ...
  // shelf stands upright in the viewer.
  ...
  metadata: {
    description:
      'Bedroom shelf model (single product) — color customization supported',
